<?php
require_once dirname(__DIR__) . '/models/AproposMission.php';

class AproposMissionController {
    private $model;

    public function __construct() {
        $this->model = new AproposMission();
    }
    ...
    public function create() {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if ($titre && $text && $icon_bootstrap) {
                if (strlen($titre) > 255 || strlen($icon_bootstrap) > 255) {
                    ...
                    header("Location: /Altiris/apropos-mission");
                    exit;
                } else {
        ...
        require_once dirname(__DIR__) . '/views/apropos_mission/create.php';
    }
    ...
    public function edit($id) {
        ...
        require_once dirname(__DIR__) . '/views/apropos_mission/edit.php';
    }
