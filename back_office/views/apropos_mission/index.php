...
?>
<h2>Gestion des Missions À Propos</h2>
<a href="/Altiris/apropos-mission/ajouter" class="btn btn-primary mb-3">Ajouter une mission</a>
            ...
            <?php foreach ($records as $record): ?>
                <li class="record-item">
                    ...
                    <div class="record-actions">
                        <a href="/Altiris/apropos-mission/modifier/<?php echo isset($record['id']) ? $record['id'] : ''; ?>" class="btn btn-warning"><i class="fas fa-edit"></i> Modifier</a>
